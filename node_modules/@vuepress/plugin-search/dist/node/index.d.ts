...
declare const prepareSearchIndex: ({
  app,
  isSearchable,
  getExtraFields
}: {
...
//#endregion
export { type SearchIndex, type SearchIndexItem, type SearchPluginLocaleData, SearchPluginOptions, prepareSearchIndex, searchPlugin };
