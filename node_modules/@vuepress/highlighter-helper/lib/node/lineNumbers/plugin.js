 ...
 * ```
 */
export const lineNumbers = (md, { lineNumbers: lineNumberOptions = true, removeLastLine, resolveLineNumbers: customResolveLineNumbers, } = {}) => {
    ...
    md.renderer.rules.fence = (...args) => {
        ...
        const code = rawCode.slice(rawCode.indexOf('<code class="language-'), rawCode.indexOf('</code>'));
        const lines = code.split('\n');
        if (removeLastLine) {
            lines.pop();
        }
        // resolve line-numbers mark from token info
        const lineNumbersInfo = customResolveLineNumbers?.(info) ??
