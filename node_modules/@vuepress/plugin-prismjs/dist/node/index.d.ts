 ...
 */
declare const highlightPlugin: (md: Markdown, { highlightLines, notationDiff: enabledDiff, notationErrorLevel: enabledErrorLevel, notationFocus: enabledFocus, notationHighlight: enabledHighlight, notationWordHighlight: enabledWordHighlight, whitespace: whitespacePosition }?: MarkdownItPrismjsHighlightOptions) => void;
//#endregion
 ...
 * @param options - Plugin options / 插件选项
 */
declare const preWrapperPlugin: (md: Markdown, { preWrapper }?: MarkdownItPreWrapperOptions) => void;
//#endregion
