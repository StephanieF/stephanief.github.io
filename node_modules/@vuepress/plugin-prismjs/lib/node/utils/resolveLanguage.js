 ...
 */
const getLanguagesMap = () => (languagesMap ??= Object.values(languages).reduce((result, item) => Object.assign(result, Object.fromEntries(item.aliases.map((alias) => [alias, item]))), {}));
/**
