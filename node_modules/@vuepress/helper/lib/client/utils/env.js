...
const getPlatform = () => navigator.userAgentData?.platform ?? navigator.platform;
 ...
 */
export const isiPhone = () => /\biPhone\b/i.test(getPlatform());
/**
 ...
 */
export const isWindows = () => /\b(Windows|Win32)\b/i.test(getPlatform());
/**
 ...
 */
export const isiPad = () => /\biPad\b/i.test(getPlatform());
/**
