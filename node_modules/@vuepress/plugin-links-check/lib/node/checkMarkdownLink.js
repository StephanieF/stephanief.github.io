 ...
 */
export const checkMarkdownLink = (page, app, isIgnoreLink) => {
    ...
    const brokenLinks = [
        ...
        app.pages.every(({ filePathRelative }) => filePathRelative !== decodeURI(relative)) && !isIgnoreLink(relative)),
        ...markdownLinks
        ...
        // Check whether the page exists
        absolute &&
            app.pages.every(({ filePathRelative }) => !filePathRelative ||
