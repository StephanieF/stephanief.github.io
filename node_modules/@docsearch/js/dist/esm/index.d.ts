...
//#endregion
//#region ../docsearch-core/dist/esm/index.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+client-common@5.55.2/node_modules/@algolia/client-common/dist/common.d.ts
type Cache = {
  /**
...
type Requester = {
   ...
   */
  send: (request: EndRequest) => Promise<Response$1>;
  /**
...
//#endregion
//#region ../../node_modules/.bun/@algolia+client-search@5.55.2/node_modules/@algolia/client-search/dist/browser.d.ts
...
type AutoFilteringFilterEntry$1 = string | Array<string>;
/**
 * Result of automatic filtering applied by Query Categorization.
 */
type AutoFilteringResult$1 = {
  /**
   ...
   */
  facetFilters?: Array<AutoFilteringFilterEntry$1> | undefined;
  /**
   * Optional filters automatically applied to boost relevant categories.
   */
  optionalFilters?: Array<AutoFilteringFilterEntry$1> | undefined;
};
/**
 * Confidence level of the category prediction.
 */
type CategoryPredictionBin$1 = 'certain' | 'very high' | 'high' | 'low' | 'very low';
type HierarchyPathEntry$1 = {
  /**
...
type CategoryPrediction$1 = {
  bin?: CategoryPredictionBin$1 | undefined;
  /**
   * Ordered list of category levels from root to the predicted category.
   */
  hierarchyPath?: Array<HierarchyPathEntry$1> | undefined;
};
/**
 * Classification of the query scope.
 */
type QueryCategorizationType$1 = 'narrow' | 'broad' | 'ambiguous' | 'none';
/**
...
type QueryCategorization$1 = {
  ...
  type?: QueryCategorizationType$1 | undefined;
  /**
   * List of category predictions with confidence levels.
   */
  categories?: Array<CategoryPrediction$1> | undefined;
  autofiltering?: AutoFilteringResult$1 | undefined;
};
/**
 ...
 */
type ResponseExtensions$1 = {
  queryCategorization?: QueryCategorization$1 | undefined;
};
type SearchHits$1<T = Record<string, unknown>> = Record<string, any> & {
  ...
  extensions?: ResponseExtensions$1 | undefined;
};
 ...
 */
type SearchExtensionsQueryCategorization$1 = {
  /**
 ...
 */
type SearchExtensions$1 = {
  queryCategorization?: SearchExtensionsQueryCategorization$1 | undefined;
};
/**
 * - `default`: perform a search query - `facet` [searches for facet values](https://www.algolia.com/doc/guides/managing-results/refine-results/faceting/#search-for-facet-values).
 */
...
type SearchForHitsOptions$1 = {
  ...
  extensions?: SearchExtensions$1 | undefined;
} & {
 ...
 */
type SearchResponsePartial$1<T = Record<string, unknown>> = BaseSearchResponse$1 & SearchPagination$1 & {
  [key: string]: any;
};
type SearchResult$1<T = Record<string, unknown>> = SearchResponse$2<T> | SearchForFacetValuesResponse$2 | SearchResponsePartial$1<T>;
...
type BrowseParams = BrowseParamsObject | SearchParamsString$1;
type DeleteByParams = {
  facetFilters?: FacetFilters$1 | undefined;
  /**
   * Filter expression to only include items that match the filter criteria in the response.  You can use these filter expressions:  - **Numeric filters.** `<facet> <op> <number>`, where `<op>` is one of `<`, `<=`, `=`, `!=`, `>`, `>=`. - **Ranges.** `<facet>:<lower> TO <upper>`, where `<lower>` and `<upper>` are the lower and upper limits of the range (inclusive). - **Facet filters.** `<facet>:<value>`, where `<facet>` is a facet attribute (case-sensitive) and `<value>` a facet value. - **Tag filters.** `_tags:<value>` or just `<value>` (case-sensitive). - **Boolean filters.** `<facet>: true | false`.  You can combine filters with `AND`, `OR`, and `NOT` operators with the following restrictions:  - You can only combine filters of the same type with `OR`.   **Not supported:** `facet:value OR num > 3`. - You can\'t use `NOT` with combinations of filters.   **Not supported:** `NOT(facet:value OR facet:value)` - You can\'t combine conjunctions (`AND`) with `OR`.   **Not supported:** `facet:value OR (facet:value AND facet:value)`  Use quotes if the facet attribute name or facet value contains spaces, keywords (`OR`, `AND`, `NOT`), or quotes. If a facet attribute is an array, the filter matches if it matches at least one element of the array.  For more information, see [Filters](https://www.algolia.com/doc/guides/managing-results/refine-results/filtering).
...
declare function searchClient$1(appId: string, apiKey: string, options?: ClientOptions | undefined): SearchClient$1;
type SearchClient$1 = ReturnType<typeof createSearchClient>;
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/MaybePromise.d.ts
declare type MaybePromise<TResolution> = Promise<TResolution> | TResolution;
//#endregion
//#region ../../node_modules/.bun/algoliasearch@5.55.2/node_modules/algoliasearch/dist/lite/browser.d.ts
/**
 * Range object with lower and upper values in meters to define custom ranges.
 */
type Range = {
...
type SearchResult<T = Record<string, unknown>> = SearchResponse$1<T> | SearchForFacetValuesResponse$1 | SearchResponsePartial<T>;
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/preset-algolia/algoliasearch.d.ts
...
/** @ts-ignore */
ReturnType<typeof searchClient$1>>;
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/SearchResponse.d.ts
declare type SearchResponse<TObject> = SearchResponse$2<TObject> & {
  _automaticInsights?: true;
};
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/preset-algolia/createRequester.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteEnvironment.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteReshape.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompletePlugin.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteOptions.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteSource.d.ts
...
declare type InternalAutocompleteSource$1<TItem extends BaseItem> = { [KParam in keyof AutocompleteSource$1<TItem>]-?: AutocompleteSource$1<TItem>[KParam]; };
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteCollection.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteContext.d.ts
interface AutocompleteContext {
  [key: string]: unknown;
}
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteState.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteNavigator.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteSetters.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/core/AutocompleteApi.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/js/AutocompleteRenderer.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/js/HighlightHitParams.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/js/AutocompleteComponents.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/js/AutocompleteState.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/js/AutocompleteSource.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-shared@1.19.2+3402394add40b075/node_modules/@algolia/autocomplete-shared/dist/esm/js/AutocompleteCollection.d.ts
interface AutocompleteCollection<TItem extends BaseItem> {
  source: InternalAutocompleteSource<TItem>;
  items: TItem[];
}
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-plugin-algolia-insights@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-plugin-algolia-insights/dist/esm/types/AlgoliaInsightsHit.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-plugin-algolia-insights@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-plugin-algolia-insights/dist/esm/createSearchInsightsApi.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-plugin-algolia-insights@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-plugin-algolia-insights/dist/esm/types/AutocompleteInsightsApi.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-plugin-algolia-insights@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-plugin-algolia-insights/dist/esm/types/EventParams.d.ts
...
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/_getVersion.d.ts
declare function getVersion$1(this: AlgoliaAnalytics, callback?: (version: string) => void): string;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/utils/request.d.ts
type RequestFnType = (url: string, data: Record<string, unknown>) => Promise<boolean>;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/_sendEvent.d.ts
declare function makeSendEvents(requestFn: RequestFnType): (this: AlgoliaAnalytics, eventData: InsightsEvent[], additionalParams?: InsightsAdditionalEventParams) => Promise<boolean>;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/_tokenUtils.d.ts
declare function saveTokenAsCookie(this: AlgoliaAnalytics): void;
declare function setAnonymousUserToken(this: AlgoliaAnalytics, inMemory?: boolean): void;
declare function setUserToken(this: AlgoliaAnalytics, userToken: number | string): number | string;
declare function getUserToken(this: AlgoliaAnalytics, options?: any, callback?: (err: any, userToken?: number | string) => void): number | string | undefined;
declare function onUserTokenChange(this: AlgoliaAnalytics, callback?: (userToken?: number | string) => void, options?: {
  immediate: boolean;
}): void;
declare function setAuthenticatedUserToken(this: AlgoliaAnalytics, authenticatedUserToken: number | string | undefined): number | string | undefined;
declare function getAuthenticatedUserToken(this: AlgoliaAnalytics, options?: any, callback?: (err: any, authenticatedUserToken?: number | string) => void): number | string | undefined;
declare function onAuthenticatedUserTokenChange(this: AlgoliaAnalytics, callback?: (authenticatedUserToken?: number | string) => void, options?: {
  immediate: boolean;
}): void;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/utils/extractAdditionalParams.d.ts
type WithAdditionalParams<TEventType> = InsightsAdditionalEventParams | TEventType;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/click.d.ts
...
declare function clickedObjectIDsAfterSearch(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchClickEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
...
declare function clickedObjectIDs(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsClickObjectIDsEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
...
declare function clickedFilters(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsClickFiltersEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/conversion.d.ts
interface InsightsSearchConversionEvent {
  eventName: string;
  userToken?: string;
  authenticatedUserToken?: string;
  timestamp?: number;
...
declare function convertedObjectIDsAfterSearch(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchConversionEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
declare function addedToCartObjectIDsAfterSearch(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchConversionEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
type InsightsSearchPurchaseEvent = Omit<InsightsSearchConversionEvent, "queryID"> & {
  /** @deprecated Use objectData.queryID instead. */
  queryID?: string;
};
declare function purchasedObjectIDsAfterSearch(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchPurchaseEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
interface InsightsSearchConversionObjectIDsEvent {
  eventName: string;
  userToken?: string;
  authenticatedUserToken?: string;
  timestamp?: number;
...
declare function convertedObjectIDs(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchConversionObjectIDsEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
declare function addedToCartObjectIDs(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchConversionObjectIDsEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
declare function purchasedObjectIDs(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchConversionObjectIDsEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
interface InsightsSearchConversionFiltersEvent {
  eventName: string;
  userToken?: string;
  authenticatedUserToken?: string;
  timestamp?: number;
...
declare function convertedFilters(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchConversionFiltersEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/init.d.ts
 ...
 */
declare function init(this: AlgoliaAnalytics, options?: InitParams): void;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/view.d.ts
interface InsightsSearchViewObjectIDsEvent {
  eventName: string;
  userToken?: string;
  authenticatedUserToken?: string;
  timestamp?: number;
...
declare function viewedObjectIDs(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchViewObjectIDsEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
interface InsightsSearchViewFiltersEvent {
  eventName: string;
  userToken?: string;
  authenticatedUserToken?: string;
  timestamp?: number;
...
declare function viewedFilters(this: AlgoliaAnalytics, ...params: Array<WithAdditionalParams<InsightsSearchViewFiltersEvent>>): ReturnType<AlgoliaAnalytics["sendEvents"]>;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/insights.d.ts
declare global {
  interface Window {
...
declare class AlgoliaAnalytics {
  ...
  version: string;
  init: typeof init;
  getVersion: typeof getVersion$1;
...
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/_algoliaAgent.d.ts
declare function addAlgoliaAgent(this: AlgoliaAnalytics, algoliaAgent: string): void;
//#endregion
//#region ../../node_modules/.bun/search-insights@2.17.3/node_modules/search-insights/dist/types.d.ts
type ParamReturnTypeTuple<T extends (...args: any) => any> = [Parameters<T>, ReturnType<T>];
type InsightsMethodMap$1 = {
  init: ParamReturnTypeTuple<typeof init>;
  getVersion: ParamReturnTypeTuple<typeof getVersion$1>;
...
type InsightsClient$1 = (<MethodName extends keyof InsightsMethodMap$1>(method: MethodName, ...args: InsightsMethodMap$1[MethodName][0]) => InsightsMethodMap$1[MethodName][1]) & {
  version?: string;
};
type InsightsEventType = "click" | "conversion" | "view";
type InsightsEventConversionSubType = "addToCart" | "purchase";
type InsightsEventObjectData = {
  queryID?: string;
  price?: number | string;
...
type InsightsAdditionalEventParams = {
  headers?: Record<string, string>;
  inferQueryID?: boolean;
};
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-plugin-algolia-insights@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-plugin-algolia-insights/dist/esm/types/InsightsClient.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-plugin-algolia-insights@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-plugin-algolia-insights/dist/esm/createAlgoliaInsightsPlugin.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@algolia+autocomplete-core@1.19.2+5231fce1053ff2af/node_modules/@algolia/autocomplete-core/dist/esm/types/index.d.ts
...
//#endregion
//#region ../../node_modules/.bun/@ai-sdk+provider@2.0.3/node_modules/@ai-sdk/provider/dist/index.d.ts
...
//#endregion
//#region ../../node_modules/.bun/ai@5.0.213+68a1e3a0c4588df3/node_modules/ai/dist/index.d.ts
...
//#endregion
//#region ../docsearch-react/dist/esm/index-BijiN4hK.d.ts
...
//#endregion
//#region ../docsearch-react/dist/esm/DocSearchTheme-DvL4mf0D.d.ts
//#region src/types/DocSearchTheme.d.ts
type DocSearchTheme = 'dark' | 'light';
//#endregion
//#region ../docsearch-react/dist/esm/DocSearchButton-DyJd_QGM.d.ts
//#region src/DocSearchButton.d.ts
type ButtonTranslations = Partial<{
  buttonText: string;
  buttonAriaLabel: string;
}>;
//#endregion
//#region ../docsearch-react/dist/esm/DocSearch-2gNxdJcC.d.ts
...
interface DocSearchProps$1 {
  ...
  resultsFooterComponent?: (props: ResultsFooterComponentProps) => JSX.Element | null;
  /**
   ...
   */
  footerAction?: React$1.ReactNode;
...
type TemplateFnReturnType = JSX$1.Element | string | (() => JSX$1.Element) | null;
