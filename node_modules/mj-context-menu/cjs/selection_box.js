...
var SelectionMenu = (function (_super) {
    ...
    SelectionMenu.fromJson = function (factory, _a, sb) {
        ...
        var radios = values.map(function (x) {
            return factory.get('radio')(factory, { content: x, variable: variable, id: x }, selection);
        });
...
var SelectionBox = exports.SelectionBox = (function (_super) {
    ...
    SelectionBox.prototype.rowDiv = function (sels) {
        ...
        var rects = sels.map(function (sel) {
            ...
            if (!sel.html.id) {
                sel.html.id = _this.prefix + MenuUtil.counter();
            }
    ...
    SelectionBox.prototype.display = function () {
        ...
        var _loop_1 = function (i) {
            ...
            var div = (_a = __read(this_1.rowDiv(sels), 4), _a[0]), width = _a[1], height = _a[2], column = _a[3];
            outerDivs.push(div);
    ...
    SelectionBox.prototype.left = function (event) {
        var _this = this;
        this.move(event, function (index) { return (index === 0 ? _this.selections.length : index) - 1; });
    };
    ...
    SelectionBox.orderMethod = new Map([
        [
            "alphabetical",
            function (x, y) { return x.items[0].content.localeCompare(y.items[0].content); }
        ],
