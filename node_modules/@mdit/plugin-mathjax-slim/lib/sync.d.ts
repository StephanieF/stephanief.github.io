...
import { LiteElement } from "@mathjax/src/cjs/adaptors/lite/Element.js";
...
import { TeX as TeX$1 } from "@mathjax/src/js/input/tex.js";
...
import { LiteElement as LiteElement$1 } from "@mathjax/src/js/adaptors/lite/Element.js";
...
interface MathJaxTexInputOptions {
   ...
   */
  maxBuffer?: number;
  formatError?: (jax: TeX$1<unknown, unknown, unknown>, error: typeof TexError) => MmlNode;
}
/**
 * Data passed to MathJax filters
 */
interface MathjaxFilterData {
  math: MathItem<LiteElement$1, string, HTMLElement>;
  document: MathDocument<LiteElement$1, string, HTMLElement>;
  data: any;
}
/**
...
//#endregion
export { DocumentOptions, MathjaxInstance, createMathjaxInstance, getDocumentOptions, mathjax };
