...
declare const katex: <MarkdownItEnv = unknown>(md: MarkdownIt, { allowInlineWithSpace, delimiters, mathFence, logger, transformer, ...userOptions }?: MarkdownItKatexOptions<MarkdownItEnv>) => void;
//#endregion
