...
const clearspeak_preference_string_js_1 = require("./clearspeak_preference_string.js");
class ClearspeakPreferences extends dynamic_cstr_js_1.DynamicCstr {
    ...
    static getLocalePreferences_(dynamic) {
        ...
        for (const locale of Object.keys(dynamic)) {
            ...
            for (const axis in clearspeak_preference_string_js_1.PREFERENCES.getProperties()) {
                const allSty = clearspeak_preference_string_js_1.PREFERENCES.getProperties()[axis];
...
class Parser extends dynamic_cstr_js_2.DynamicCstrParser {
    ...
    fromPreference(pref) {
        return (0, clearspeak_preference_string_js_1.fromPreference)(pref);
    }
    toPreference(pref) {
        return (0, clearspeak_preference_string_js_1.toPreference)(pref);
    }
}
const REVERSE_MAPPING = [
    ['AbsoluteValue', semantic_meaning_js_1.SemanticType.FENCED, semantic_meaning_js_1.SemanticRole.NEUTRAL],
    ['AbsoluteValue', semantic_meaning_js_1.SemanticType.FENCED, semantic_meaning_js_1.SemanticRole.METRIC],
    ['Bar', semantic_meaning_js_1.SemanticType.OVERSCORE, ''],
    ['Caps', semantic_meaning_js_1.SemanticType.IDENTIFIER, semantic_meaning_js_1.SemanticRole.LATINLETTER, 'category:Lu'],
    ['CombinationPermutation', semantic_meaning_js_1.SemanticType.APPL, semantic_meaning_js_1.SemanticRole.UNKNOWN],
    ['Currency', semantic_meaning_js_1.SemanticType.IDENTIFIER, semantic_meaning_js_1.SemanticRole.UNIT, 'unit:currency'],
    ['Currency', semantic_meaning_js_1.SemanticType.INFIXOP, semantic_meaning_js_1.SemanticRole.UNIT, 'unit:currency'],
    ['Enclosed', semantic_meaning_js_1.SemanticType.ENCLOSE, ''],
    ...
    ['Log', semantic_meaning_js_1.SemanticType.APPL, semantic_meaning_js_1.SemanticRole.PREFIXFUNC, 'appl:Logarithm'],
    ['Log', semantic_meaning_js_1.SemanticType.FUNCTION, semantic_meaning_js_1.SemanticRole.PREFIXFUNC, 'category:Logarithm'],
    ...
    ['MultiLineOverview', semantic_meaning_js_1.SemanticType.MULTILINE, ''],
    ['MultiLineLabel', semantic_meaning_js_1.SemanticType.TABLE, semantic_meaning_js_1.SemanticRole.LABEL],
    ['MultiLinePausesBetweenColumns', semantic_meaning_js_1.SemanticType.TABLE, ''],
    ['MultiLineOverview', semantic_meaning_js_1.SemanticType.TABLE, ''],
    ['MultiLineLabel', semantic_meaning_js_1.SemanticType.CASES, semantic_meaning_js_1.SemanticRole.LABEL],
    ['MultiLinePausesBetweenColumns', semantic_meaning_js_1.SemanticType.CASES, ''],
    ['MultiLineOverview', semantic_meaning_js_1.SemanticType.CASES, ''],
    [
        'MultsymbolDot',
    ...
    ['Inference', semantic_meaning_js_1.SemanticType.INFERENCE, ''],
    ['Inference', semantic_meaning_js_1.SemanticType.PREMISES, ''],
    ['Inference', semantic_meaning_js_1.SemanticType.RULELABEL, ''],
    ['Inference', semantic_meaning_js_1.SemanticType.CONCLUSION, '']
];
